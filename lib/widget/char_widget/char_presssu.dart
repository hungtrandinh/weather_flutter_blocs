...
class _BarChart extends StatelessWidget {
  ...
  List<BarChartGroupData> get barGroups => [
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[0].fivedayMain.pressure.toDouble(),
        ...
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[8].fivedayMain.pressure.toDouble(),
                colors: [Colors.lightBlueAccent, Colors.greenAccent])
          ],
          showingTooltipIndicators: [0],
        ),
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[16].fivedayMain.pressure.toDouble(),
                colors: [Colors.lightBlueAccent, Colors.greenAccent])
          ],
          showingTooltipIndicators: [0],
        ),
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[24].fivedayMain.pressure.toDouble(),
                colors: [Colors.lightBlueAccent, Colors.greenAccent])
          ],
          showingTooltipIndicators: [0],
        ),
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[32].fivedayMain.pressure.toDouble(),
                colors: [Colors.lightBlueAccent, Colors.greenAccent])
          ],
          showingTooltipIndicators: [0],
        ),
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: fivedaydata[39].fivedayMain.pressure.toDouble(),
                colors: [Colors.lightBlueAccent, Colors.greenAccent])
          ],
          showingTooltipIndicators: [0],
        ),
